...
scrollThumbFrame.InputBegan:Connect(function(input, gameProcessed)
    ...
    if input.UserInputType == Enum.UserInputType.Touch then
        ...
        local function doTick()
            ...
            print("touchPos[dir]:", touchPos[dir])
            print("scrollThumb.AbsolutePosition[dir]:", scrollThumb.AbsolutePosition[dir])
            print("scrollThumb.AbsoluteSize[dir]:", scrollThumb.AbsoluteSize[dir])
            print("incrementValue:", incrementValue)
            
            if ScrollDirection == 0 and touchPos[dir] < scrollThumb.AbsolutePosition[dir] then
                print("Calling ScrollTo with:", self.Index - (incrementValue * 5))
...
function self:ScrollTo(index, nocallback)
    self.Index = index
    self:Update() -- Ensure Update handles Index properly
...
function self:AddMarker(ind, color)
...
function self:SetScrollFrame(frame)
