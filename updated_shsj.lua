  ...
  if gethui then
    -- Some executors provide gethui
    Window.Parent = gethui()
  elseif fluxus and fluxus.protect_gui then
    -- Fluxus
    fluxus.protect_gui(Window)
    Window.Parent = CoreGui
  elseif secure_gui then
    -- Delta, Acceus, Codex, or any executor with secure_gui
    secure_gui(Window)
    Window.Parent = CoreGui
  else
    -- If none of the above, fallback to setting the parent directly
    Window.Parent = CoreGui or game:GetService('Players').LocalPlayer:WaitForChild('PlayerGui')
  end
    Window.Parent = CoreGui
  end
